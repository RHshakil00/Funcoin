                                                                            ...
                                                                            spinnerFrame(0)
{
	...
	QString windowTitle = tr("FunCoin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
	...
	aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About FunCoin"), this);
	...
	showHelpMessageAction->setStatusTip(tr("Show the FunCoin help message to get a list with possible FunCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
	...
	QString toolTip = tr("FunCoin client") + " " + networkStyle->getTitleAddText();
