...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextFunCoin = QChar (0xA9) + QString (" 2021-%1 ").arg (COPYRIGHT_YEAR) + QString (tr("The FunCoin developers"));
	...
	pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 48, copyrightTextFunCoin);
