...
In order to support loading of multiple wallets in funcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is funcoin.cpp.
...
Changes to funcoin.cpp
----------------------
funcoin.cpp is the entry point into funcoin-qt, and as such, will require some minor modifications to provide hooks for
