...
#   c) node1 mines 32 blocks, so now node 0 has 60001FUN, node 1 has 4250FUN, node2 has none.
#   d) node0 sends 601 FUN to node2, in two transactions (301 FUN, then 300 FUN).
