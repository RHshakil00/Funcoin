...
RESOURCES += src/qt/funcoin.qrc src/qt/funcoin_locale.qrc

TRANSLATIONS += src/qt/locale/funcoin_bg.ts \
                src/qt/locale/funcoin_de.ts \
                src/qt/locale/funcoin_en.ts \
                src/qt/locale/funcoin_es.ts \
                src/qt/locale/funcoin_fi.ts \
                src/qt/locale/funcoin_fr.ts \
                src/qt/locale/funcoin_it.ts \
                src/qt/locale/funcoin_ja.ts \
                src/qt/locale/funcoin_pl.ts \
                src/qt/locale/funcoin_pt.ts \
                src/qt/locale/funcoin_ru.ts \
                src/qt/locale/funcoin_sk.ts \
                src/qt/locale/funcoin_sv.ts \
                src/qt/locale/funcoin_vi.ts \
                src/qt/locale/funcoin_zh_CN.ts \
                src/qt/locale/funcoin_zh_TW.ts
