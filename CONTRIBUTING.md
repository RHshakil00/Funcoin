Contributing to FunCoin
============================

The FunCoin project operates an open contributor model where anyone is
...
The following applies to code changes to the FunCoin project, and is not to be
confused with overall FunCoin Network Protocol consensus changes.

Whether a pull request is merged into FunCoin rests with the project merge
...
The project leader is the release manager for each FunCoin release.
